        ...
        configContent={
          <div className="space-y-2">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              ...
              in your SuperPlane environment, then run containers with the gVisor runtime:
            </p>
        ...
        configContent={
          <div className="space-y-2">
            <p className="text-xs text-gray-600 dark:text-gray-400">
              ...
              in your SuperPlane environment. Docker must be accessible from the SuperPlane process:
            </p>
            <pre className="text-xs font-mono bg-gray-900 text-gray-100 rounded p-3 overflow-x-auto">
