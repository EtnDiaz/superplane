...
type ApiOrganizationsDescribeUsageRequest struct {
	ctx context.Context
	ApiService *OrganizationAPIService
	id string
}

func (r ApiOrganizationsDescribeUsageRequest) Execute() (*OrganizationsDescribeUsageResponse, *http.Response, error) {
	return r.ApiService.OrganizationsDescribeUsageExecute(r)
}

/*
OrganizationsDescribeUsage Describe organization usage

Returns usage tracking and limits for an organization

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id
 @return ApiOrganizationsDescribeUsageRequest
*/
func (a *OrganizationAPIService) OrganizationsDescribeUsage(ctx context.Context, id string) ApiOrganizationsDescribeUsageRequest {
	return ApiOrganizationsDescribeUsageRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return OrganizationsDescribeUsageResponse
func (a *OrganizationAPIService) OrganizationsDescribeUsageExecute(r ApiOrganizationsDescribeUsageRequest) (*OrganizationsDescribeUsageResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *OrganizationsDescribeUsageResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationAPIService.OrganizationsDescribeUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
